// Package clockface provies functions that calculate the positions of the hands of an analogue clock.
package clockface
...
// A Point represents a two-dimensional Cartesian coordinate. They are used in the package.
